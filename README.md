...
Step 4 : Use this code to set up the bot; \
         ...
         Press Enter \
         5. notepad bot.js
         Press Enter - now here notepad will open, prompting you to create a new file because te bot isnt there yet, decline it, check on your powershell the location where the volatility 25 folder was created and download the javascript file for volatility 25 above and paste it there. \
         6. notepad bot .js
